...
const Qualifications = ( {} ) => {
    ...
    return ( 
        <div id="qualifications" className="w-full">
            <div id="experience-container" className="w-full h-full py-5 text-white m-auto rounded-2xl">
                ...
                { keyqualifications && keyqualifications.map(experience => (
                    <div className="experience w-full place-content-center md:p-5 xl:grid xl:grid-cols-2 xl:gap-2" key={ experience.id }>
